...
class Threads extends EmbedParserAbstract implements EmbedParserCustomInterface
{
    public function regex()
    {
        return [
            'https?://(?:www\.)?threads\.net/(.*)/post/(?P<id>[a-zA-Z0-9_-]+)',
        ];
    }
